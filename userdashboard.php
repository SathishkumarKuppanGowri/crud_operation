    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item nav-pills">
          <a class="nav-link active text-light" aria-current="page" href="userdashboard.php">User Dashboard</a>
        </li>
        
        
      </ul>
      <li class="nav">
          <a class="nav-link ms-auto" aria-current="page" href="Order_details.php">Orders</a>
        </li>
      <li class="nav">
...
<div class="container ">
<form class="d-flex m-1" action="userdashboard.php" method="get">
